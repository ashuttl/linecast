...
- Moon: `--calendar islamic` follows the Umm al-Qura calendar: the Hijri date beside the phase (23 Ramadan 1447 AH), turning at your own sunset, the coming month, and the next observance from Islamic New Year through Eid al-Adha. The month starts are computed by Saudi Arabia's civil rule from the ephemeris and checked against the published calendar for 1423 through 1500 AH; a country's announced dates may differ by a day.
