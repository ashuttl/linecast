...
- Moon: `--calendar islamic` follows the Umm al-Qura calendar: the Hijri date beside the phase (23 Ramadan 1447 AH), turning at your own sunset, the coming month, and the next observance from Islamic New Year through Eid al-Adha, with "begins at sunset" on the day before. The month starts are computed by Saudi Arabia's civil rule from the ephemeris and checked against the published calendar for 1423 through 1500 AH; a country's announced dates may differ by a day.
- Moon: `--calendar hebrew` follows the Hebrew calendar: the date beside the phase (20 Elul 5786), turning at your own sunset, the coming month, and the next holiday from Rosh Hashanah through Tisha B'Av, with "begins at sunset" on the day before. The month grid names each holiday's days and marks the month starts, and the hover chip notes Rosh Chodesh. `--json` carries the date in Hebrew letters too (כ׳ אלול תשפ״ו). Every month of 5780 through 5790 is checked against Hebcal; the holidays follow the place: a location in Israel keeps one day of Yom Tov, anywhere else two.
