...
- Text in scripts that stack marks on their letters — Devanagari, Thai, Arabic — now measures the width terminals give it, so Hindi alerts and Indic place names line up.
