...
- Maps: The clouds near the poles, where the satellites cannot see, are drawn from the forecast model with the grain and brightness of the satellite picture around them, instead of as a smooth bright veil with a straight edge.
