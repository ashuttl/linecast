...
- Maps: Nearby prepared detail is reused during motion, reducing redundant work and coastline/border jitter during slow globe rotation. Live frames send fewer repeated color instructions to the terminal. Partially loaded street and elevation views retry missing detail automatically.
