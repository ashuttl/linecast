...
- Moon: `--calendar hebrew` follows the Hebrew calendar: the date beside the phase (20 Elul 5786), turning at your own sunset, the coming month, and the next holiday from Rosh Hashanah through Tisha B'Av, with "begins at sunset" on the day before. The month grid names each holiday's days and marks the month starts, and the hover chip notes Rosh Chodesh. Every month of 5780 through 5790 is checked against Hebcal; the holidays are the diaspora dates.
