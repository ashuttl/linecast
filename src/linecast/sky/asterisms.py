...
ASTERISMS = [
    {"name": "Big Dipper",
     ...
     "names": {"fr": "Grande Casserole", "es": "El Carro", "de": "Großer Wagen",
               ...
               "eo": "Granda Ĉaro", "tr": "Büyük Kepçe", "fa": "هفت\u200cاورنگ",
    ...
    {"name": "Little Dipper",
     ...
     "names": {"fr": "Petite Casserole", "es": "Carro Menor", "de": "Kleiner Wagen",
               ...
               "zh-Hant": "小北斗",
               "eo": "Malgranda Ĉaro", "tr": "Küçük Kepçe", "fa": "هفت\u200cاورنگ کهین",
    ...
    {"name": "Summer Triangle",
     ...
     "names": {"fr": "Triangle d'été", "es": "Triángulo de verano", "de": "Sommerdreieck",
               ...
               "zh-Hant": "夏季大三角",
               "vi": "Tam Giác Mùa Hè",
               "eo": "Somera Triangulo", "tr": "Yaz Üçgeni", "fa": "مثلث تابستانی",
    ...
    {"name": "Winter Triangle",
     ...
     "names": {"fr": "Triangle d'hiver", "es": "Triángulo de invierno", "de": "Winterdreieck",
               ...
               "eo": "Vintra Triangulo", "tr": "Kış Üçgeni", "fa": "مثلث زمستانی",
    ...
    {"name": "Winter Hexagon",
     ...
     "names": {"fr": "Hexagone d'hiver", "es": "Hexágono de invierno", "de": "Wintersechseck",
               ...
               "eo": "Vintra Seslatero", "tr": "Kış Altıgeni", "fa": "شش\u200cضلعی زمستانی",
    ...
    {"name": "Spring Triangle",
     ...
     "names": {"fr": "Triangle de printemps", "es": "Triángulo de primavera",
               ...
               "eo": "Printempa Triangulo", "tr": "İlkbahar Üçgeni", "fa": "مثلث بهاری",
    ...
    {"name": "Northern Cross",
     ...
     "names": {"fr": "Croix du Nord", "es": "Cruz del Norte", "de": "Kreuz des Nordens",
               ...
               "zh-Hant": "北十字",
               "eo": "Norda Kruco", "tr": "Kuzey Haçı", "fa": "صلیب شمالی",
    ...
    {"name": "Orion's Belt",
     ...
     "names": {"fr": "Baudrier d'Orion", "es": "Cinturón de Orión", "de": "Oriongürtel",
               ...
               "zh-Hant": "獵戶座腰帶",
               "eo": "Zono de Oriono", "tr": "Orion Kuşağı", "fa": "کمربند شکارچی",
