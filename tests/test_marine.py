...
class FormatMarineLineTests(unittest.TestCase):
    def _runtime(self, metric=False, lang="en"):
        return TidesRuntime(live=False, icons="nerd", lang=lang, metric=metric, oneline=False)
...
class FormatHeightTests(unittest.TestCase):
    def _runtime(self, metric=False):
        return TidesRuntime(live=False, icons="nerd", lang="en", metric=metric, oneline=False)
