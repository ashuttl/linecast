...
class TestFetchHistorical:
    ...
    def test_returns_averages_on_success(self):
        ...
        with patch("linecast.weather.historical.fetch_json_cached", return_value=mock_data):
    ...
    def test_returns_none_on_failure(self):
        with patch("linecast.weather.historical.fetch_json_cached", return_value=None):
            result = fetch_historical(40.7, -74.0, date(2026, 3, 27))
        assert result is None

    def test_returns_none_on_empty_data(self):
        with patch("linecast.weather.historical.fetch_json_cached",
    ...
    def test_celsius_flag_passed_to_url(self):
        ...
        with patch("linecast.weather.historical.fetch_json_cached", return_value=None) as mock:
