...
def test_open_meteo_tides(failures):
    from linecast.tides.openmeteo import (fetch_hilo_range_openmeteo,
...
def test_noaa_tides(failures):
    from linecast.tides.noaa import fetch_hilo_range, fetch_station_metadata_noaa
...
def test_queensland_tides(failures):
    from linecast.tides.qld import (fetch_hilo_range_qld, fetch_station_metadata_qld,
...
def test_hko_tides(failures):
    from linecast.tides.hko import (fetch_hilo_range_hko, fetch_station_metadata_hko,
...
def test_tidecheck_tides(failures, monkeypatch):
    ...
    from linecast.tides.tidecheck import (fetch_hilo_range_tidecheck,
...
def test_librewxr_radar_index(failures):
    from linecast.radar.tiles import fetch_index, librewxr_provider
...
def test_rainviewer_radar_index(failures):
    from linecast.radar.tiles import fetch_index, rainviewer_provider
...
def test_iem_radar_frame(failures):
    from linecast.radar.sources import IEMSource
    source = IEMSource(3)
...
def test_iem_warnings(failures):
    from linecast.radar.warnings import warnings_at
